...
- _Misused identity_: Όταν υπάρχουν στοιχεία που καταδεικνύουν ότι τα προσωπικά δεδομένα κάποιου έχουν χρησιμοποιηθεί κακόβουλα.
...
- Στην κακόβουλη χρήση ταυτότητας μεσω υπάρχοντος λογαριασμού έναντι δημιουργίας νέου, πρώτα έρχονται τα κοινωνικά δίκτυα έναντι των πιστωτικών καρτών
...
- Περίπτωση [Microsoft](https://www.thestack.technology/microsoft-data-breach-azure-bluebleed/) 2022: όπου προβληματική παραμετροποίηση στο Azure εξέθεσε 2.4 terabytes δεδομένων που ανήκαν σε 150.000 εταιρίες από 123 χώρες με υπογεγραμμένα έγγραφα, emails και άλλες ευαίσθητες πληροφορίες
- Περίπτωση [Amazon](https://techcrunch.com/2022/10/27/amazon-prime-video-server-exposed/?guccounter=1) 2022: όπου βάση δεδομένων μη προστατευμένη με κωδικό ήταν δημόσια προσβάσιμη και εξέθεσε 215 εκατομμύρια εγγραφές με πληροφορίες streaming της Prime σχετικές με τη συνδρομή, τη συσκευή μετάδοσης και άλλα.
