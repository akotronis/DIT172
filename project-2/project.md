...
Σε σχέση με ατα κίνητρα, παρατηρεί κανείς στην δεύτερη έρευνα ότι, μάλλον αναμενόμενα, πρώτο έρχεται το προσωπικό ή οικονομικό όφελος με 96% σε όλες και 71% στις μεγάλες επιχιρήσεις ενώ δεύτερη η διαμαρτυρία/προσωπική διαφωνία με 3% και 25% αντίστοιχα.
